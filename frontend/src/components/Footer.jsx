  ...
  return (
    <footer className="footer">
      ...
      <div className="footer-grid">
        ...
        <div><h4>Explore</h4><Link to="/products">All products</Link><Link to="/category/medicines">Medicines</Link><Link to="/category/wellness">Wellness</Link><Link to="/myorder">My orders</Link></div>
        <div><h4>Help</h4><Link to="/support">Care support</Link><a href="mailto:medikart@gmail.com">Contact us</a><Link to="/myorder">Delivery & returns</Link><Link to="/privacy">Privacy</Link></div>
